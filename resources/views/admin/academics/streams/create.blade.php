{{-- resources/views/admin/academics/streams/create.blade.php --}}
@extends('layouts.app')

@section('page_title', 'Add Stream')

@section('content')
<div class="flex items-center justify-between mb-5">
    <div>
        <h1 class="text-2xl font-semibold text-slate-900">Add Stream</h1>
        <p class="text-sm text-slate-500 mt-1">Create a stream under a class</p>
    </div>
...
<form method="POST" action="{{ route('admin.streams.store') }}" class="max-w-3xl space-y-6">
    @csrf
